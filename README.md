...
### If you snooze on news - you lose.

**Nooze** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] Replaced Filter Settings Activity with a lightweight modal overlay - I replaced it below the tab bar
...
<img src='http://i.giphy.com/3o7TKGJoKBpbEVvwUo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
